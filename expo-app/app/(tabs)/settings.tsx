      ...
      <SafeAreaView className='bg-background-0 h-full'>
         <ScrollView
            ...
            <Box className='mt-4 bg-primary-0 rounded-[15px] p-[12] pb-[12]'>
               ...
               <View>
                  ...
                  <Input
                     ...
                     <InputField onChangeText={(e: string) => handleInputChange('water_goal', e)}>
                        {settings?.water_goal}
                     </InputField>
                  </Input>
                  ...
                  <Input
                     ...
                     isDisabled={activeEditSection !== 'goals'}>
                     <InputField
                        onChangeText={(e: string) => handleInputChange('creatine_goal', e)}>
            ...
            <Box className='mt-4 bg-primary-0 rounded-[15px] p-[12] pb-[12]'>
               ...
               <View>
                  ...
                  <Input
                     ...
                     <InputField onChangeText={(e: string) => handleInputChange('height', e)}>
                        {settings?.height}
                     </InputField>
                  </Input>
                  ...
                  <Input
                     className='h-[45]'
                     isDisabled={activeEditSection !== 'metrics'}>
                     <InputField onChangeText={(e: string) => handleInputChange('weight', e)}>
                        {settings?.weight}
                     </InputField>
                  </Input>
                  ...
                  <Select
                     ...
                     <SelectTrigger
                        ...
                        size='md'>
                        <SelectInput
                           placeholder={settings?.sex != null ? settings?.sex : 'Select'}
                        />
                        <SelectIcon
                           className='mr-3'
                           as={ChevronDownIcon}
            ...
            <Box className='mt-4 bg-primary-0 rounded-[15px] p-[12] pb-[12]'>
               ...
               <View>
                  <Text className='text-[14px] pt-[8] py-[4] text-typography-300'>Drink Unit</Text>
                  <Select
                     className='h-[45]'
                     isDisabled={activeEditSection !== 'preferences'}
                     onValueChange={(value: string) => handleInputChange('drink_unit', value)}>
                     <SelectTrigger
                        className='h-[45] justify-between'
                        variant='outline'
                        size='md'>
                  ...
                  <Select
                     className='h-[45] mb-[5]'
                     isDisabled={activeEditSection !== 'preferences'}
                     onValueChange={(value: string) => handleInputChange('supplement_unit', value)}>
                     <SelectTrigger
                        className='h-[45] justify-between'
                        variant='outline'
                        size='md'>
