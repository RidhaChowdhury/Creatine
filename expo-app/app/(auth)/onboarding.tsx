        ...
        <SafeAreaView className="bg-background-0 h-full">
            ...
            >
                ...
                <Input className="h-[45]" isRequired={true} isInvalid={isNameInvalid}>
                    <InputField
                        placeholder="Sammy"
                        onChangeText={(e: string) => setFormData((prev) => ({ ...prev, name: e }))}
                    ></InputField>
                </Input>
                ...
                <Input className="h-[45]" isRequired={true} isInvalid={isHeightInvalid}>
                    <InputField
                        ...
                        onChangeText={(e: string) =>
                            setFormData((prev) => ({ ...prev, height: e }))
                        }
                    ></InputField>
                </Input>
                <View className="flex-row items-center justify-between">
                        ...
                        <AlertDialogContent>
                            ...
                            <AlertDialogBody className="mt-3 mb-4">
                                <Text size="sm">
                                    ...
                                    hydration and creatine intake recommendations tailored to your
                                    body. These factors help us estimate your daily needs, so you
                                    get the right balance for optimal performance and well-being.
                                </Text>
                            </AlertDialogBody>
                ...
                <Input className="h-[45]" isRequired={true} isInvalid={isWeightInvalid}>
                    <InputField
                        placeholder="200"
                        onChangeText={(e: string) =>
                            setFormData((prev) => ({ ...prev, weight: e }))
                        }
                    ></InputField>
                </Input>
