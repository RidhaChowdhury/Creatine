   ...
   useEffect(() => {
      const fetchWaterData = async () => {
         try {
            ...
            const { data, error } = await supabase.rpc('get_water_heatmap_data', {
               user_uuid: user.id,
      ...
      const fetchWaterForms = async () => {
         try {
            ...
            const { data, error } = await supabase.rpc('get_water_form_distribution', {
               user_uuid: user.id
            });
      ...
      const fetchWaterConsistency = async () => {
         try {
            ...
            const { data, error } = await supabase.rpc('get_water_consistency', {
               user_uuid: user.id
            });
      ...
      const fetchStreak = async () => {
         try {
            ...
            const { data, error } = await supabase.rpc('get_water_streak', {
               user_uuid: user.id
            });
      ...
      const fetchDaysLogged = async () => {
         try {
            ...
            const { data, error } = await supabase.rpc('get_water_days_logged', {
               user_uuid: user?.id
            });
