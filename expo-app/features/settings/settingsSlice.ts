...
export const updateSettings = createAsyncThunk<UserSettings, { formData: UserSettings }, { state: RootState }>(
...
export const addSettings = createAsyncThunk<UserSettings, {formData: OnboardingSettings }, { state: RootState }>(
